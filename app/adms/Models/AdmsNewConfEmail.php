...
class AdmsNewConfEmail extends AdmsConn
{
    ...
    private function emailHTML():void
    {
        ...
        $this->emailData['contentHtml'] .= "Esta mensagem foi enviada a você pela empresa CG Advocacia previdenciária. <br>Você está recebendo porque está cadastrado no banco de dados da empresa. Nenhum e-mail enviado pela empresa tem arquivos anexados ou solicita o preenchimento de senhas e informações cadastrais.<br><br>";
    }
