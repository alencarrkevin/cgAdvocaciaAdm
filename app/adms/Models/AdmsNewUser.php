...
class AdmsNewUser
{
    ...
    private function contentEmailHtml(): void
    {
        ...
        $this->emailData['contentHtml'] .= "Esta mensagem foi enviada a você pela empresa CG ADVOCACIA PREVIDENCIARIA.<br>Você está recebendo porque está cadastrado no banco de dados da empresa. Nenhum e-mail enviado pela empresa tem arquivos anexados ou solicita o preenchimento de senhas e informações cadastrais.<br><br>";
    }
    ...
    private function contentEmailText(): void
    {
        ...
        $this->emailData['contentText'] .= "Esta mensagem foi enviada a você pela empresa CG Advocacia previdenciária.\nVocê está recebendo porque está cadastrado no banco de dados da empresa. Nenhum e-mail enviado pela empresa tem arquivos anexados ou solicita o preenchimento de senhas e informações cadastrais.\n\n";
    }
}
