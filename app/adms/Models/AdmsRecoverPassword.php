...
class AdmsRecoverPassword
{
    ...
    private function emailHTML():void
    {
        ...
        $this->emailData['contentHtml'] .= "Você solicitou a recuperação da sua senha!<br><br>";
        $this->emailData['contentHtml'] .= "Para continuar o processo de recuperação de sua senha, clique no link abaixo: <br><br>";
        $this->emailData['contentHtml'] .= "<a href='{$this->url}'>{$this->url}</a><br><br>";
        $this->emailData['contentHtml'] .= "Se voce não solicitou a recuperação da sua senha, Nenhuma ação adicional será necessária. Sua senha permanece a mesma.<br><br>";
    }

    private function emailText():void
    {
        $this->emailData['contentText'] = "Prezado(a) {$this->firstName}\n\n";
        $this->emailData['contentText'] .= "Você solicitou a recuperação da sua senha!\n\n";
        $this->emailData['contentText'] .= "Para continuar o processo de recuperação de sua senha, clique no link abaixo: \n\n";
        $this->emailData['contentText'] .=  $this->url . "\n\n";
        $this->emailData['contentText'] .= "Se voce não solicitou a recuperação da sua senha, Nenhuma ação adicional será necessária\nSua senha permanece a mesma.\n\n";
    }
}
