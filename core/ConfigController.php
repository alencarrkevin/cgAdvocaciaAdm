...
class ConfigController extends Config
{
    ...
    {
        // Definir mapeamento de caracteres especiais
        $formatA = 'ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖØÙÚÛÜüÝÞßàáâãäåæçèéêëìíîïðñòóôõöøùúûýýþÿRr"!@#$%&*()_-+={[}]?;:.,\\\'<>°ºª ';
        $formatB = 'aaaaaaaceeeeiiiidnoooooouuuuuybsaaaaaaaceeeeiiiidnoooooouuuyybyRr------------------------------------------';
        ...
        $this->url = strtr($this->url, $formatA, $formatB);
    }
